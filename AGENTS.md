# php-text-intelligence

PHP demo app for Deepgram Text Intelligence.
...
```
feat(php-text-intelligence): add diarization support
fix(php-text-intelligence): resolve WebSocket close handling
refactor(php-text-intelligence): simplify session endpoint
